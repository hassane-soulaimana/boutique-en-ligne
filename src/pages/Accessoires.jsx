...
export default function Accessoires() {
  ...
  useEffect(() => {
    async function loadAccessoires() {
      try {
        ...
        // Charger tous les produits et filtrer les accessoires
        ...
        console.log('📦 Accessoires filtrés:', accessoiresData);
  ...
  // FILTRAGE
  // ------------------------
  let produitsFiltres = accessoires.filter((p) => {
    ...
    <main className="min-h-screen bg-gradient-to-b from-stone-50 to-white">
      ...
      <section className="relative text-white py-32 overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1611195974226-a6a9be9dd763?w=1920&q=80')"
          }}
        ></div>
        ...
        <div className="container mx-auto px-6 lg:px-20 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-semibold tracking-tight leading-tight text-white drop-shadow-lg">
              Accessoires
              <span className="block text-amber-100 mt-2">Premium</span>
            </h1>
            <p className="text-xl lg:text-2xl font-light text-stone-200 max-w-2xl mx-auto leading-relaxed drop-shadow">
              Étuis, tapis de jeu, horloges et bien plus pour sublimer votre expérience échecs.
            </p>
          </motion.div>
        </div>
      </section>
              ...
              >
                <div>
                  <p className="text-stone-600 text-lg">
                    <span className="font-semibold text-stone-900">{produitsFiltres.length}</span> accessoire{produitsFiltres.length > 1 ? 's' : ''} disponible{produitsFiltres.length > 1 ? 's' : ''}
                  </p>
                </div>
              </motion.div>
  ...
  {produit.prix.toFixed(2)} €
              ...
              {produitsAffiches.length === 0 && (
                ...
                >
                  <p className="text-stone-500 text-lg">Aucun accessoire ne correspond à vos critères.</p>
                  <button
                    onClick={() => {
                      setCollectionFiltre('');
                      setPrixRange('');
