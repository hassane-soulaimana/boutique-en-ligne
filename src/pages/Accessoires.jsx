        ...
        <div className="flex-1">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-600 text-lg">
              {produitsFiltres.length} accessoire{produitsFiltres.length > 1 ? 's' : ''} disponible{produitsFiltres.length > 1 ? 's' : ''}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {produitsAffiches.map((produit) => (
              ...
              >
                <div className="h-48 bg-gradient-to-br from-pink-100 to-yellow-100 flex items-center justify-center text-5xl">
                  {produit.image}
                </div>
                <div className="p-6">
